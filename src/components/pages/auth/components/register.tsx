...
import {
  RegisterFormTypes as DefaultRegisterFormTypes,
  RegisterPageProps,
...
interface RegisterFormTypes extends DefaultRegisterFormTypes {
  first_name?: string;
  last_name?: string;
}
      ...
      <CardContent sx={{ p: "32px", "&:last-child": { pb: "32px" } }}>
        ...
        >
          ...
          <TextField
            ...
            margin="normal"
            fullWidth
            label={translate("pages.register.first_name", "First Name")}
          ...
          <TextField
            ...
            margin="normal"
            fullWidth
            label={translate("pages.register.last_name", "Last Name")}
            error={!!errors.first_name}
